                    ...
                    <ul className="collapsible">
                        <li>
                            ...
                            <div id="collapsibleBody" className="collapsible-body">
                                <span>1º - Yasmin</span><br />
                                <span>2º - Icaro</span><br />
                            </div>
                        </li>
                        <li>
                            <div id="collapsibleHeader" className="collapsible-header">
                            ...
                            <div id="collapsibleBody" className="collapsible-body">
                                ...
                                <h6>Masculino</h6>
                                <hr />
                                <span>1º - Icaro</span><br />
                                <h6>Outro</h6>
                                <hr />
                                <span>1º - Gerson</span><br />
                        ...
                        <li>
                            ...
                            <div id="collapsibleBody" className="collapsible-body">
                                ...
                                <span>3º - Desodorante</span><br />
                                <span>4º - Corte de Cabelo</span><br />
                                <span>5º - Barba</span><br />
                            </div>
                        </li>
                        <li>
                            <div id="collapsibleHeader" className="collapsible-header">
