...
export default function ListaCliente() {
  ...
  function historico() {
    if (nome === "Yasmin") {
      console.log(nome);
      return <HistoricoYasmin />;
    } else if (nome === "Icaro") {
      console.log(nome);
      return <HistoricoIcaro />;
    }
  }
        ...
        <ul className="collapsible">
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              ...
              <br />
              <span>E-mail: gerson@ge.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
          ...
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              <span>Nome Social: Mima</span>
              <br />
              <span>Sexo: F</span>
              <br />
              <span>Data de Nascimento: 12/4/2000</span>
              <br />
              <span>CPF: 12345678912</span>
              <br />
              <span>E-mail: mima@mimaa.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
              <span>Telefone: 454234</span>
              <br />
              <span>Endereço: </span>
              <br />
          ...
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              <span>Nome Social: Icaro</span>
              <br />
              <span>Sexo: M</span>
              <br />
              <span>Data de Nascimento: 3/4/1999</span>
              <br />
              <span>CPF: 12345678912</span>
              <br />
              <span>E-mail: icaro@icaro.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
              <span>Telefone: 7565785</span>
              <br />
              <span>Endereço: </span>
              <br />
